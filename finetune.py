...
def get_args():
	...
	parser.add_argument("--train_path", type = str, default = "drive/My Drive/Colab Notebooks/train")
	parser.add_argument("--test_path", type = str, default = "drive/My Drive/Colab Notebooks/test")
